...
def add_user(user):
    ...
    user1.save()
    print(f"Item {user.username}added.")
...
add_user(User(username="user", accountType=2, password="user", email="user@gmail.com", profilePhoto="photo", address="UnitedCollege, CUHK"))